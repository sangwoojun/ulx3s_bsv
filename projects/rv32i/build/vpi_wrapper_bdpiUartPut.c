 ...
 *     #include "vpi_wrapper_bdpiUartPut.h"
 *     void (*vlog_startup_routines[])() = { bdpiUartPut_vpi_register, 0u };
 */
#include <stdlib.h>
#include <vpi_user.h>
#include "bdpi.h"
...
void bdpiUartPut_vpi_register()
{
  ...
  tf_data.tfname = "$imported_bdpiUartPut";
  tf_data.calltf = bdpiUartPut_calltf;
  tf_data.compiletf = 0u;
  tf_data.sizetf = 0u;
  tf_data.user_data = "$imported_bdpiUartPut";
